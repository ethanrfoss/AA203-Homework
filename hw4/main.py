...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint-path", type=str, default="qlearning_agent_policy_20250605_115232.pth", help="path to the checkpoint of a trained policy network (for test mode)")
